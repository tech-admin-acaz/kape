...
interface CarbonValuationBarChartProps {
...
const CarbonValuationBarChart: React.FC<CarbonValuationBarChartProps> = ({ data, isLoading }) => {
...
export default CarbonValuationBarChart;
